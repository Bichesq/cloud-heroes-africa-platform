...
/* LP top navigation (adapted from student-hub TopBar) — the mockups show two
 * primary tabs: My Courses and Explore Programs. The profile menu links back
 * to Student Hub for dashboard/profile (those surfaces own that UX). */

const TABS = [
  { href: "/catalog", label: "Explore Programs" },
  { href: "/courses", label: "My Program" },
];
...
export default function TopBar({ givenName, familyName, email, avatarUrl }: Props) {
  ...
  return (
    <header className="flex h-[88px] shrink-0 items-stretch bg-cha-canvas">
      ...
      {/* Cols 2 & 3 — tabs / utilities / profile */}
